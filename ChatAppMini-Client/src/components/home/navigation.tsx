          ...
          <div className="flex items-center space-x-3">
            {userData ? (
              <div className="flex items-center space-x-3">
                  ...
                  <AnimatePresence>
                    {isDropdownOpen && (
                      ...
                      >
                        ...
                        <button onClick={handleLogout} className="cursor-pointer flex items-center space-x-3 px-4 py-2 text-red-600 hover:bg-red-50 transition-colors w-full text-left">
                ...
                <Link href="/chat">
                  <Button className="cursor-pointer w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 transform">
